...
def compile_file(filename, steps, results, supporting_dir, basedir, web, student):
    ...
    if web:
        server_path += '-o "{}/server/server_file" '.format(basedir)
        server_path += '"{}/data/supporting/sd_fun.h" '.format(basedir)
        server_path += '"{}/data/supporting/sd_fun.o" '.format(basedir)
        server_path += '"{}/data/supporting/str_util.o"'.format(basedir)
